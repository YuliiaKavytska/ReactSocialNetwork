...
// замыкаем функцию влидации на значении 50 символов. в переменной храниться функция
// нельзя замыкать эту функцию внутри нашей формы. иначе будет зацикливание.
// поэтому обязательно замыкаем ее здесь в переменную
